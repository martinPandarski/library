...
const HorizontalLine = () => {
    return (<div style={{ display: "flex", justifyContent: "center", alignItems: "center", flex: "99" }}>

        <hr style={{ width: "100%", height: "0.7px", background: "#1076b5" }} />
        ...
        <div className={styles.settings}>
            ...
            <div className={styles["book-settings"]}>
                <div className={styles["top-bar"]}>
                    <h3>Book Settings</h3>
                    <Button className={styles['add-new-btn']} variant="contained">Add New</Button>
                </div>
